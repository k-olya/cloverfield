...
export function Menu() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-gray-800 rounded-lg shadow-lg max-w-md w-full h-full max-h-[90dvh] md:max-h-[70vh] md:mt-0">
        <div className="p-3 pb-0">
          <h1 className="text-3xl font-bold text-center mb-3">{t("Find emoji")}</h1>
        </div>
